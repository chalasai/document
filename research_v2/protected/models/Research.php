...
class Research extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, research_group_id', 'required'),
	...
	public function findAllResearchGroup()
	{
		$groups = researchGroup::model()->findAll(array('order'=>'code'));
		$list = CHtml::listData($groups,'id', 'code');
		return $list;
	}
}